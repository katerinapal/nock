...
import ext_timers from "timers";
import ext_lodashset from "lodash.set";
import ext_debug from "debug";
'use strict'

const debug = ext_debug('nock.common')
const set = ext_lodashset
const timers = ext_timers
const url = ext_url
const util = ext_util
