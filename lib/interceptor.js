...
import match_body_match_body from "./match_body";
import intercept_interceptjs from "./intercept";
import common_commonjs from "./common";
import ext_url from "url";
import ext_querystring from "querystring";
import ext_jsonstringifysafe from "json-stringify-safe";
'use strict'

const stringify = ext_jsonstringifysafe
const querystring = ext_querystring
const { URL, URLSearchParams } = ext_url

const common = common_commonjs
const { remove } = intercept_interceptjs
const matchBody = match_body_match_body
...
mod_interceptorjs = class Interceptor {
  /**
   *
...
export default mod_interceptorjs;
