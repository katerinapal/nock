import playback_interceptor_playback_interceptorjs from "./playback_interceptor";
import socket_socketjs from "./socket";
import global_emitter_global_emitterjs from "./global_emitter";
import common_commonjs from "./common";
import ext_propagate from "propagate";
import ext_https from "https";
import ext_http from "http";
import ext_debug from "debug";
'use strict'

const debug = ext_debug('nock.request_overrider')
const {
  IncomingMessage,
  ClientRequest,
  request: originalHttpRequest,
} = ext_http
const { request: originalHttpsRequest } = ext_https
const propagate = ext_propagate
const common = common_commonjs
const globalEmitter = global_emitter_global_emitterjs
const Socket = socket_socketjs
const { playbackInterceptor } = playback_interceptor_playback_interceptorjs
...
mod_intercepted_request_routerjs = { InterceptedRequestRouter }
var mod_intercepted_request_routerjs;
export default mod_intercepted_request_routerjs;
