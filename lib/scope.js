 ...
 * @module nock/scope
 */
const { addInterceptor, isOn } = intercept_interceptjs
const common = common_commonjs
const assert = ext_assert
const url = ext_url
const debug = ext_debug('nock.scope')
const { EventEmitter } = ext_events
