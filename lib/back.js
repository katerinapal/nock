...
import scope_scopejs from "./scope";
import intercept_interceptjs from "./intercept";
import recorder_recorderjs from "./recorder";
import ext_assert from "assert";
'use strict'

const assert = ext_assert
const recorder = recorder_recorderjs
const {
  activate,
  disableNetConnect,
  enableNetConnect,
  removeAll: cleanAll,
} = intercept_interceptjs
const { loadDefs, define } = scope_scopejs

const { format } = ext_util
const path = ext_path
const debug = ext_debug('nock.back')
