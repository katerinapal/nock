import interceptor_interceptorjs from "./interceptor";
...
import intercepted_request_router_intercepted_request_routerjs from "./intercepted_request_router";
'use strict'
...
const { InterceptedRequestRouter } = intercepted_request_router_intercepted_request_routerjs
const common = common_commonjs
const { inherits } = ext_util
const http = ext_http
const debug = ext_debug('nock.intercept')
...
function removeInterceptor(options) {
  ...
  const Interceptor = interceptor_interceptorjs
...
var mod_interceptjs;
export default mod_interceptjs;
