import imp_interceptorjs from "./interceptor";
...
import imp_intercepted_request_routerjs from "./intercepted_request_router";
'use strict'
...
const { InterceptedRequestRouter } = imp_intercepted_request_routerjs
...
function removeInterceptor(options) {
  ...
  const Interceptor = imp_interceptorjs
